<script lang="ts">
  ...
  // Further adapted from https://github.com/lorenzolewis/starlight-utils/blob/main/packages/starlight-utils/components/Dropdown.astro
...
{#each sidebarArray as sidebar}
  <div
    hidden={!sidebar.isCurrentSidebar}
    data-starlight-multi-sidebar-label={sidebar.labelEntry.label}
  >
